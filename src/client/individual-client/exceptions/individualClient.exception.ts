...
export class IndividualClientAlreadyExistException extends HttpException {
  constructor() {
    super(
      {
...
export class IndividualClientNotFoundException extends HttpException {
  constructor() {
    super(
      {
        statusCode: HttpStatus.BAD_REQUEST,
        message: EXCEPTION.INDIVIDUALCLIENT_NOT_FOUND,
        error: ErrorEnum.BAD_REQUEST,
      },
      HttpStatus.BAD_REQUEST
    );
